...
export const ClassificationStats = React.lazy(() => import('./classifications'))
export const Classifiers = React.lazy(() => import('./classifiers'))
...
const Clubs = UnderConstruction
const Shooters = UnderConstruction
